...
public class PlayerAnimationC : MonoBehaviour {
    ...
    /* 
     * This handles the animation with the click to move script. This also calls the NavMesh -- Mama
     */

    void New_PlayerInput()
    {
        moveHorizontal = GetComponent<NavMeshAgent>().desiredVelocity.x;
        moveVertical = GetComponent<NavMeshAgent>().desiredVelocity.z;
    ...
    /* 
     * This was originally in the Update method. This handles the animation with a input is pressed.
     * This is part of the original ARPG framework. -- Mama
     */

    void Old_PlayerInput()
    {
